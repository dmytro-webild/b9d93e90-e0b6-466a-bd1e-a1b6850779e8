...
import { Award, Heart, Sparkles, Utensils, Wifi, Wine } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Friendly staff welcoming guests",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/indian-butter-chicken-black-bowl-wooden-table_123827-20634.jpg",
          imageAlt: "Spread of delicious Indian dishes",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/udaipur-city-view-from-hotel-balcony-rajasthan-india_53876-65506.jpg",
          imageAlt: "Exterior facade of Purohit Misthan Bhandar",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Our Legacy of Sweetness and Service",
        },
      ]}
      buttons={[
        {
      ...
      body="Purohit Misthan Bhandar Goluwala has been a cherished name in hospitality and culinary arts for generations. We are dedicated to preserving traditional recipes, offering a warm dining experience, and providing comfortable accommodation. Our commitment to quality ingredients, authentic flavors, and impeccable service sets us apart, making every visit a memorable one. From delectable sweets to savory dishes and restful stays, we are your trusted destination."
      ...
      features={[
        {
          ...
          description: "Handcrafted with traditional recipes and premium ingredients, our sweets are a treat for every occasion.",
          media: {
            ...
            imageAlt: "Display of various Indian sweets",
          },
          items: [
            {
              icon: Sparkles,
        ...
        },
        {
          ...
          description: "Savor a wide range of authentic Indian and regional cuisines prepared by expert chefs in our elegant restaurant.",
          media: {
            ...
            imageAlt: "Elegant restaurant dining table",
          },
          items: [
            {
              icon: Utensils,
        ...
        },
        {
          ...
          description: "Relax and unwind in our well-appointed rooms, designed for comfort and convenience, whether for business or leisure.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/stair-pool_1203-2592.jpg",
      ...
      products={[
        {
          ...
          imageAlt: "Delicious Gulab Jamun",
        },
        {
          id: "p2",
          brand: "Purohit's",
          ...
          rating: 4,
          reviewCount: "95",
          imageSrc: "http://img.b2bpic.net/free-photo/biscuit-pop-cakes-plate-marble-table_114579-83774.jpg",
          imageAlt: "Soft Rasgulla",
        },
        {
          id: "p3",
          brand: "Purohit's",
          ...
          rating: 5,
          reviewCount: "150",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-plate-with-pakistani-food_23-2148825158.jpg",
          imageAlt: "Crispy Samosa",
        },
        {
          id: "p4",
          brand: "Purohit's",
          ...
          imageAlt: "Traditional Vegetarian Thali",
        },
        {
          id: "p5",
          brand: "Purohit's",
          ...
          rating: 5,
          reviewCount: "110",
          imageSrc: "http://img.b2bpic.net/free-photo/front-close-view-tasty-salad-with-mayonnaise-vegetables-cheese-dark-blue-background_140725-49042.jpg",
          imageAlt: "Aromatic Biryani",
        },
        {
          id: "p6",
          brand: "Purohit's",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/signs-symbols-gestures-concept-cheerful-young-mixed-race-lady-with-long-straight-hair-smiling-broadly-showing-thumbs-up-gesture-as-sign-approval-respect-liking_344912-1033.jpg",
          alt: "Priya Sharma",
        },
        {
          src: "http://img.b2bpic.net/free-photo/indian-man-city-male-traditional-turban-hinduist-summer-city_1157-41025.jpg",
          alt: "Anil Singh",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-smiling-young-woman-using-mobile-phone-holding-cookie-hand_23-2148137425.jpg",
          alt: "Deepika Patel",
        },
        {
          src: "http://img.b2bpic.net/free-photo/smiling-pretty-brunette-woman-points-front-with-two-hands-isolated-olive-green-wall_141793-65779.jpg",
          alt: "Happy Customer",
        },
      ]}
  ...
  <div id="social-proof" data-section="social-proof">
      ...
      useInvertedBackground={false}
      names={[
        "Goluwala's Best Sweet Shop",
        "Top Rated Restaurant",
        "Preferred Hotel Partner",
        "Culinary Excellence Award",
        "Local Business Star",
        "Customer Choice Award",
        "Featured in Foodie Magazine",
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we provide comprehensive catering services for weddings, corporate events, and private parties. Please contact us for customized menu options.",
        },
        {
          id: "faq2",
          title: "What are the check-in and check-out times for the hotel?",
          content: "Standard check-in time is 2:00 PM and check-out is 12:00 PM. Early check-in or late check-out may be available upon request and subject to availability.",
        },
        {
          id: "faq3",
          title: "Can I place an order for sweets online or for delivery?",
          content: "Currently, we offer in-store pickup and local delivery services within Goluwala. Online ordering is available through partner platforms. Please check our contact page for details.",
        },
        {
          id: "faq4",
          title: "Do you have vegetarian and vegan options in the restaurant?",
          content: "Yes, our restaurant offers a wide array of vegetarian dishes and we are happy to accommodate vegan preferences upon request. Please inform our staff about your dietary needs.",
        },
        {
          id: "faq5",
          title: "Are pets allowed in the hotel rooms?",
          content: "To ensure the comfort of all our guests, pets are generally not allowed. Please contact our reception directly if you have specific service animal requirements.",
        },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Location: Goluwala",
              href: "#contact",
            },
            {
              label: "Call: +91 12345 67890",
              href: "tel:+911234567890",
            },
            {
              label: "Email: info@purohit.com",
              href: "mailto:info@purohit.com",
            },
            {
              label: "FAQs",
              href: "#faq",
